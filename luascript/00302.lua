function LuaQ_420291_Accept()
	...
	local DOG = CreateObjByFlag( 100143 , 580037 , 0 , 1)
...
function LuaQ_420291_LeadB()
	...
	local FlagID	= 580037;	-- FlagID	路徑旗子群組代瑪
...
function LuaQ_420291_Friend()
	...
	WriteRoleValue( OwnerID() ,EM_RoleValue_IsWalk , 1  )
 	LuaFunc_MoveToFlag( OwnerID(), 580037 , 10 ,0 )
	Sleep( 20 )
	SetPlot( OwnerID() , "touch" , "" , 40)
	sleep( 300 )
	SetPlot( OwnerID() , "touch" , "LuaFunc_Obj_BUSY" , 40)
 	LuaFunc_MoveToFlag( OwnerID(), 580037 , 11 ,0 )
	sleep( 20 )
	DelObj( OwnerID() )	
end
-----------------------------------------------------------------------------------------------------------
