...
function LuaI_Demo_NPC_Create()
	Hide( OwnerID() )
	local NPC = {}
	NPC[0] = CreateObjByFlag( 100317 , 580007 , 0 , 1 )
	NPC[1] = CreateObjByFlag( 100316 , 580007 , 1 , 1 )
	NPC[2] = CreateObjByFlag( 100316 , 580007 , 2 , 1 )
	NPC[3] = CreateObjByFlag( 100318 , 580007 , 3 , 1 )
	NPC[4] = CreateObjByFlag( 100319 , 580007 , 4 , 1 )
	NPC[5] = CreateObjByFlag( 100320 , 580007 , 5 , 1 )
	NPC[6] = CreateObjByFlag( 100321 , 580007 , 6 , 1 )
	NPC[7] = CreateObjByFlag( 100322 , 580007 , 7 , 1 )
	for i = 0 , 3 , 1 do
	...
	LuaFunc_MoveToFlag( NPC[4], 580007 , 12 ,0 )
--	sleep(20)
	Say( NPC[0] , "原來是你。" )
	sleep(10)
...
function LuaI_Demo_Battle()
	...
	LuaFunc_MoveToFlag( OwnerID(), 580007 , flag,0 )
end