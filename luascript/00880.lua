...
function LuaS_Discowood_InstanceMonster(MonsterBoss , HowMuch ,  Monster1 , RoomID)
	local Array = {}
	local Boss = CreateObjByFlag( MonsterBoss, 580087 , 0 , 1 )
	AddToPartition( Boss ,   RoomID )
	Array[0] = Boss
	for i=1 , HowMuch do
		local Monster = CreateObjByFlag( Monster1, 580087 , i , 1 )
