...
--function AlreadyLivingSkill3()	-- 完成物資補充挖礦
--	if ( CountBodyItem( TargetID() , 530000 ) == true ) then	-- 重要物品：挖礦學徒
--	else
--		GiveBodyItem( TargetID() , 530000 , 1 )
--	end
--end
--function AlreadyLivingSkill2()	-- 完成物資補充伐木
--	if ( CountBodyItem( TargetID() , 530001 ) == true ) then	-- 重要物品：伐木學徒
--	else
--		GiveBodyItem( TargetID() , 530001 , 1 )
--	end
--end
--function AlreadyLivingSkill1()	-- 完成物資補充採藥
--	if ( CountBodyItem( TargetID() , 530002 ) == true ) then	-- 重要物品：採藥學徒
--	else
--		GiveBodyItem( TargetID() , 530002 , 1 )
--	end
--end
