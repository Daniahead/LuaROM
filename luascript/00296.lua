...
function LuaQ_420275_Complete()
	...
	local n =0
		...
		--MoveToFlagEnabled( OwnerID(), false )
		--WriteRoleValue( OwnerID() ,EM_RoleValue_IsWalk , 1  )
		--LuaFunc_MoveToFlag( OwnerID(), 580029 , 1 , 0 )
	SetPosByFlag( OwnerID(), 580029 , 1 )
	SetPlot( OwnerID() , "touch" , "LuaFunc_Obj_Nothing", 10 )
	...
	sleep(1)
		...
		--LuaFunc_MoveToFlag( OwnerID() , 580029, 0 , 0 )
		--MoveToFlagEnabled( OwnerID(), true );
	sleep( 30 )
	SetPlot( OwnerID() , "touch" , "", 10 )
	Show( Wolf[0] , 0 )
