...
--建立一個 table，在想產生物件的位置用 LuaFunc_CreateNPCByMatrix(ObjID,Matrix,A,B ) 產生物件。 其中四個數值依序代表 1.要生成的物件ID 2.作為基準的陣列 3.列位置 4.行位置
	...
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix(100636,Matrix,2, 0 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix(100914,Matrix,3, 0 )
	ObjMatrix[5] = LuaFunc_CreateNPCByMatrix(100914,Matrix,3, 1 )
	ObjMatrix[6] = LuaFunc_CreateNPCByMatrix(100914,Matrix,3,-1 )
