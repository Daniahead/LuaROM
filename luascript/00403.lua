...
function LuaFunc_110539_Dead()
	local AA = CreateObjByFlag( 100078 , 580020 , 4 , 1 )
	BeginPlot( AA , "LuaFunc_110539_Drama" , 0 )
	return true
end

function LuaFunc_110539_Drama()
	local AA = CreateObjByFlag( 100078 , 580020 , 5 , 1 )
...
function LuaS_421456() --可疑的信件
	...
	ShowBorder( OwnerID(), 421456, GetObjNameByGUID(202888), "ScriptBorder_Texture_Paper" );	
