...
function LuaP_110030_0()
	...
	local FlagID	= 580025;	-- FlagID	路徑旗子群組代瑪
	...
	SetRoleCamp( OwnerID() , "NPC" )  --設定NPC的陣營回到不會被攻擊
