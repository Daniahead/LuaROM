...
function LuaS_421426_0()
	...
	ShowBorder( OwnerID(), 421426, GetObjNameByGUID(421426), "ScriptBorder_Texture_Paper" )
...
function LuaS_421427_0()
	...
	local Monster1 = LuaS_Discowood_FlagShowMonster( 100884 , TargetID() , 580089 , 1 , "LuaS_421427_1" )
	local Monster2 = LuaS_Discowood_FlagShowMonster( 100884 , TargetID() , 580090 , 2 , "LuaS_421427_2" )
	local Monster3 = LuaS_Discowood_FlagShowMonster( 100884 , TargetID() , 580091 , 1 , "LuaS_421427_3" )
	local Monster4 = LuaS_Discowood_FlagShowMonster( 100884 , TargetID() , 580092 , 1 , "LuaS_421427_4" )
