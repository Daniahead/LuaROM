...
function LuaS_420743_delete( ItemID , ItemNum  )
	if ( DelBodyItem ( OwnerID() , ItemID , ItemNum ) ) then				
		CastSpell( OwnerID(), OwnerID(), 491203 )
		return true
	else
		return false
	end
...
function LuaS_420744_start()
	...
	local f = 0
	local fc = GetMoveFlagCount( 580077)-1--黑曜石旗標
	while 1 do
		local fx = GetMoveFlagValue( 580077, f , EM_RoleValue_X)
		local fy = GetMoveFlagValue( 580077, f , EM_RoleValue_Y)
		local fz = GetMoveFlagValue( 580077, f , EM_RoleValue_Z)
	...
	local s = 0--讓斥候跑向隊長
	local f = 0
	local fc = GetMoveFlagCount( 580078)-1
	while 1 do
		local fx = GetMoveFlagValue( 580078, f , EM_RoleValue_X)
		local fy = GetMoveFlagValue( 580078, f , EM_RoleValue_Y)
		local fz = GetMoveFlagValue( 580078, f , EM_RoleValue_Z)
	...
	local s = 0--讓巡視者跑向玩家
	local f = 0
	local fc = GetMoveFlagCount( 580078)-2
	while 1 do
		local fx = GetMoveFlagValue( 580078, f , EM_RoleValue_X)
		local fy = GetMoveFlagValue( 580078, f , EM_RoleValue_Y)
		local fz = GetMoveFlagValue( 580078, f , EM_RoleValue_Z)
