...
--建立一個 table，在想產生物件的位置用 LuaFunc_CreateNPCByMatrix(ObjID,Matrix,A,B ) 產生物件。 其中四個數值依序代表 1.要生成的物件ID 2.作為基準的陣列 3.列位置 4.行位置
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix(100916,Matrix,1,-2 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix(100916,Matrix,1, 2 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix(100913,Matrix,5, 0 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix(100636,Matrix,6, 0 )
	ObjMatrix[5] = LuaFunc_CreateNPCByMatrix(100914,Matrix,6, 1 )
	ObjMatrix[6] = LuaFunc_CreateNPCByMatrix(100914,Matrix,6,-1 )
	ObjMatrix[7] = LuaFunc_CreateNPCByMatrix(100044,Matrix,4, 0 )
	ObjMatrix[8] = LuaFunc_CreateNPCByMatrix(100636,Matrix,5, 3 )
	ObjMatrix[9] = LuaFunc_CreateNPCByMatrix(100636,Matrix,5, -3 )
