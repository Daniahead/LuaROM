...
function LuaFunc_personalfollow()
	...
	while 1 do
		...
		if GetDistance( OwnerID(), playerID ) > 200 then
			...
			if ( GetMoveFlagValue( 580074 , flag_number  , EM_RoleValue_X ) / 10 ) == ( ReadRoleValue( OwnerID(), EM_RoleValue_X) / 10 )  then
				if ( GetMoveFlagValue( 580074 , flag_number  , EM_RoleValue_Z ) / 10 ) == ( ReadRoleValue( OwnerID(), EM_RoleValue_Z) / 10 )  then
					...
					Move( OwnerID(), GetMoveFlagValue( 580074 , flag_number  , EM_RoleValue_X )  , GetMoveFlagValue( 580074 , flag_number  , EM_RoleValue_Y )  , GetMoveFlagValue( 580074 , flag_number  , EM_RoleValue_Z )  )
