...
Function LuaI_200936_Quest()
	...
	ShowBorder( OwnerID(), 420349, GetObjNameByGUID(GetUseItemGUID(OwnerID())), "ScriptBorder_Texture_Paper" )	
...
Function LuaI_201635_Quest()
	...
	ShowBorder( OwnerID(), 420733, GetObjNameByGUID(GetUseItemGUID(OwnerID())), "ScriptBorder_Texture_Paper" )	

end
--詔告天下
function LuaQ_420733_Complete()
	local Name = GetName( TargetID() )
	RunningMsg( OwnerID() , 1 , GetString("SAY_420733_0")..Name..GetString("SAY_420733_1") ) 
end
--------------------------------------------------------------------------------------------------------------
--怪異的信
Function LuaI_201646_Quest()
	...
	ShowBorder( OwnerID(), 420761, GetObjNameByGUID(GetUseItemGUID(OwnerID())), "ScriptBorder_Texture_Paper" )	
...
Function LuaI_200432_Quest()
	...
	ShowBorder( OwnerID(), 0, GetObjNameByGUID(GetUseItemGUID(OwnerID())), "ScriptBorder_Texture_Paper" )	
...
Function LuaI_202787_Quest()
	...
	ShowBorder( OwnerID(), 421388, GetObjNameByGUID(GetUseItemGUID(OwnerID())), "ScriptBorder_Texture_Paper" )	
