...
function LuaS_420635_callone()
	...
	SetRoleCamp( followobj  , "Player" )--改變陣營
...
function LuaS_420635()
	...
	local f = 0 --目前走到第幾根旗子
	local fc =  GetMoveFlagCount( 580074 )--有多少隻旗子 
	...
	sleep(10)--等一秒
	while 1 do--無限迴圈
		local fx = GetMoveFlagValue( 580074 , f , EM_RoleValue_X )--抓階段旗的x
		local fy = GetMoveFlagValue( 580074 , f , EM_RoleValue_Y )--抓階段旗的y
		local fz = GetMoveFlagValue( 580074 , f , EM_RoleValue_Z )--抓階段旗的z
