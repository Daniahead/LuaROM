function LuaI_420233()
	SetPlot(OwnerID(),"Rang","LuaI_420233_1",50)
end
...
function LuaQ_420233_0()
	...
	sleep( 50 )	
	SetPosByFlag( OwnerID(), 580027 , 1 )	
	LuaFunc_MoveToFlag( OwnerID(), 580027 , 2 ,0 )	
	Hide( OwnerID() )
	sleep( 30 )
...
--	CastSpell( TrueBaecy , MobB , 123456 )
	...
	sleep( 30 )	
	local Saerlohas = CreateObjByFlag( 100119 , 580027 , 3 , 1 )--代100260
	AddToPartition( Saerlohas,ReadRoleValue( OwnerID() , EM_RoleValue_RoomID ) )
	SetRoleCamp( Saerlohas , "NPC" ) --別讓玩家給他秒了
	...
	sleep( 30 )
	local Mob1 = CreateObjByFlag( 100261 , 580027 , 4 , 1 )
	AddToPartition( Mob1,ReadRoleValue( OwnerID() , EM_RoleValue_RoomID ))
	SetRoleCamp( Mob1 , "NPC" ) 
	local Mob2 = CreateObjByFlag( 100262 , 580027, 5 , 1 )
	AddToPartition( Mob2,ReadRoleValue( OwnerID() , EM_RoleValue_RoomID ))
	SetRoleCamp( Mob2 , "NPC" )
