...
function LuaI_110252_3()
	...
	local OGD = CreateObjByFlag( 110734 , 580036 , 2 , 1 )
	DisableQuest(OGD, true )
	AddtoPartition( OGD , 0 )
	CastSpell( OGD, OGD, 490102 );-- 命令巨石陣施展一個法術產生新特效
	sleep(50)--休息3秒
