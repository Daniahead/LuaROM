...
function New_Hand_Weapon( Option )
	...
	local WeaponGroup = { 210511 , 210512 , 210513 , 210514 , 210515 , 210516 }		-- 戰士、遊俠、影行、法師、祭司、騎士
...
function New_Hand_Armor( Option )
	...
	local ArmorGroup = { 221581 , 221582 , 221583 , 221584 , 221585 , 221586 }		-- 戰士、遊俠、影行、法師、祭司、騎士
...
function New_Hand_Potion( Option )
	...
	local RedPotionGroup = { 5 , 5 , 5 , 2 , 2 , 3 }		-- 戰士、遊俠、影行、法師、祭司、騎士
	local BluePotionGroup = { 0 , 0 , 0 , 3 , 3 , 2 }		-- 戰士、遊俠、影行、法師、祭司、騎士
