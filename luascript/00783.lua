...
function LuaS_421428_0()
	...
	local ClassHighNo = LuaS_Discowood_FlagShowMonster( 100889 , "NoTarget" , 580089 , 3 , "LuaS_421428_6"  )
	local Monster1 = LuaS_Discowood_FlagShowMonster( 100885 , ClassHighNo , 580089 , 2 , "LuaS_421428_1" )
	local Monster2 = LuaS_Discowood_FlagShowMonster( 100885 , ClassHighNo , 580090 , 2 , "LuaS_421428_2" )
	local Monster3 = LuaS_Discowood_FlagShowMonster( 100885 , ClassHighNo , 580091 , 2 , "LuaS_421428_3" )
	local Monster4 = LuaS_Discowood_FlagShowMonster( 100886 , ClassHighNo , 580092 , 2 , "LuaS_421428_4" )
	local Monster5 = LuaS_Discowood_FlagShowMonster( 100886 , ClassHighNo , 580093 , 2 , "LuaS_421428_5" )
	local sec = 0
	local Friend = {}
	local Monster = {
			[1] = Monster1,
	...
	while true  do
		...
		if 	sec == 20 and
			...
			local Friend1 = LuaS_Discowood_FlagShowMonster( 100892 , "NoTarget" , 580089 , 0 , "LuaS_421428_7"   )
			Say( Friend1 , GetString("SC_421428_6") )--團長有危險！兄弟們上啊！
			local Friend2 = LuaS_Discowood_FlagShowMonster( 100890 , "NoTarget" , 580091 , 0  , "LuaS_421428_7"  )
			local Friend3 = LuaS_Discowood_FlagShowMonster( 100890 , "NoTarget" , 580092 , 0  , "LuaS_421428_7"  )
			local Friend4 = LuaS_Discowood_FlagShowMonster( 100890 , "NoTarget" ,  580093 , 0 , "LuaS_421428_7"  )
			Friend = {
					[1] = Friend1 ,
					[2] = Friend2 ,
					[3] = Friend3 ,
