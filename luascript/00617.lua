...
--控制對話內容--
	...
	elseif ( ReadRoleValue( OwnerID() , EM_RoleValue_Skill_Alchemy) == 60 ) then  --等級60提示要玩家去黑曜石要塞
		SetSpeakDetail( OwnerID(), GetString ( "ST_110809_4" )   );--#哇～你的程度已經那麼高了......應該可以叫你去找煉金術大師了.......不過姐姐跟我說不能告訴別人煉金術大師的消息，只能說那個人的消息在黑曜石要塞......抱歉了，我不知道為什麼姐姐要這樣子說，但如果想提升煉金術的能力，你就去黑曜石要塞看看吧！
