...
function LuaI_421116_2()
	if CheckAcceptQuest( OwnerID() , 421116 ) ==  true and Checkflag( OwnerID(), 541298) == true then
		BeginCastBar( OwnerID(), GetString("SC_421116") , 30 , ruFUSION_ACTORSTATE_CRAFTING_BEGIN , ruFUSION_ACTORSTATE_CRAFTING_END , 0 );
		while 1 do
			sleep( 2 );
...
function LuaI_421117_2()
	if CheckAcceptQuest( OwnerID() , 421117 ) ==  true and Checkflag( OwnerID(), 541303) == true then
		BeginCastBar( OwnerID(), GetString("SC_421117") , 30 , ruFUSION_ACTORSTATE_CRAFTING_BEGIN , ruFUSION_ACTORSTATE_CRAFTING_END , 0 );
		while 1 do
			sleep( 2 );
			local CastBarStatus = CheckCastBar( OwnerID() );
		if ( CastBarStatus ~= 0 ) then 
