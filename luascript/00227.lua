...
--	SetPlot( OwnerID() , "touch" , "LuaFunc_Obj_Nothing" , 10 )
	...
	Slayer1 = CreateObjByFlag ( 100078 , 580020, 2 ,1)
	AddToPartition(Slayer1 , 0)
	Slayer2 = CreateObjByFlag ( 100078  , 580020, 3 ,1)
	...
	sleep(30)
	LuaFunc_MoveToFlag( OwnerID(), 580020 , 0 ,0 )
