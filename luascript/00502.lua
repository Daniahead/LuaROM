...
function LuaI_East_EnterHomeB()
	--SetPlot( OwnerID() , "collision" , "LuaS_East_EnterHomeB" , 0 )
end
...
function LuaI_West_EnterHomeA()
	--SetPlot( OwnerID() , "collision" , "LuaS_West_EnterHomeA" , 0 )
end
...
function LuaI_West_EnterHomeB()
	--SetPlot( OwnerID() , "collision" , "LuaS_West_EnterHomeB" , 0 )
end
...
function LuaS_HomeFT_Draw()	-- 家具商人一般開商店
	...
	elseif ( RND2 > 95 and RND2 <= 100 ) then
		...
		Tell( OwnerID() , TargetID() , GetString("SO_HOMEFT_STR1")..FT1..GetString("SO_HOMEFT_STR2")..FT2..GetString("SO_HOMEFT_STR3") )
end
