...
function LuaS_DEGRADE_ALCHEMY() --煉金用
	local NPC = ReadRoleValue( TargetID() , EM_RoleValue_OrgID)
		...
		if(ReadRoleValue ( OwnerID(), EM_RoleValue_SkillMax_Alchemy ) == 80) then
...
function LuaS_DEGRADE_COOK() --烹飪用
	local NPC = ReadRoleValue( TargetID() , EM_RoleValue_OrgID)
		...
		if(ReadRoleValue ( OwnerID(), EM_RoleValue_SkillMax_Cook ) == 80) then
...
function LuaS_DEGRADE_MAKEARMOR() --製甲用
	local NPC = ReadRoleValue( TargetID() , EM_RoleValue_OrgID)
		...
		if(ReadRoleValue ( OwnerID(), EM_RoleValue_SkillMax_MakeArmor ) == 80) then
...
function LuaS_DEGRADE_BLACKSMITH() --打鐵用
	local NPC = ReadRoleValue( TargetID() , EM_RoleValue_OrgID)
		...
		if(ReadRoleValue ( OwnerID(), EM_RoleValue_SkillMax_BlackSmith ) == 80) then
...
function LuaS_DEGRADE_CARPENTER() --木工用
	local NPC = ReadRoleValue( TargetID() , EM_RoleValue_OrgID)
		...
		if(ReadRoleValue ( OwnerID(), EM_RoleValue_SkillMax_Carpenter ) == 80) then
...
function LuaS_DEGRADE_TAILOR() --裁縫用
	local NPC = ReadRoleValue( TargetID() , EM_RoleValue_OrgID)
		...
		if(ReadRoleValue ( OwnerID(), EM_RoleValue_SkillMax_Tailor ) == 80) then
