...
function LuaI_BossPlay()
	...
	Say( OwnerID(),GetString("SAY_100074_0")) --/*你們可以先讓我離開這些咒縛，我就能幫助你們更多。
	sleep(10)
	Say( Ser1,GetString("SAY_100069_0")) --/*經由索雷爾頓之環的示意，在整個計畫更完善之前，我們不希望有太大的動作而打草驚蛇。
	sleep(10)
	Say( OwnerID(),GetString("SAY_100074_1")) --/*喔？我看你們只是想要這個筆記吧！說到底你們只是在利用我！
	sleep(10)
	Say( Ser1,GetString("SAY_100069_1")) --/*不要太著急，我們的計畫必然會使虛界與現實合而為一，到時候你自然能獲得離開這裡的力量。						
	sleep(10)
	Say( OwnerID(),GetString("SAY_100074_2")) --/*別以為自己擁有和我相同的地位，我現在雖然缺乏力量，但要殺死你們仍輕而易舉。
	sleep(10)
	Say( Ser1,GetString("SAY_100069_2")) --/*閣下，但這些從剛剛就在這裡的入侵者，似乎代表你的力量有點...嗯...連關好門都有問題吧？
	sleep(20)

	Say( OwnerID(),GetString("SAY_100074_4")) --/*趁還能笑的時候笑吧！等你們看到他們怎麼死的，我相信你們會學到與我交涉時應該具備的禮貌。
	Say( Ser1,GetString("YELL_100069")) --/*閣下的幽默很值得欣賞，但為了保險起見，我們也會加入戰鬥，請閣下見諒。
...
function LuaI_BossDoor_Zone2A_2()
	...
	Say( V_Ankaria,GetString("SAY_100074_3")) --/*可惡......如果能脫離這個禁錮我的牢籠，我真正的力量......
	return true
end