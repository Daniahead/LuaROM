...
function LuaSS_110073_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110073_0")) --唉呀，忙死了！忙死了！ 
	Sleep(2000)
	end
end
...
function LuaSS_110068_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110068_0")) --我該怎麼讓傑爾瞭解我的心意呢？...
	Sleep(1830)
	end
end
...
function LuaSS_110077_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110077_0")) --想當年我一把劍可以砍殺千萬個敵人，現在….唉唷唷～我的腰好痛～～
	Sleep(2900)
	end
end
...
function LuaSS_110076_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110076_0")) --有沒有送送信、照顧貓的工作呢？
	Sleep(3430)
	end
end
...
function LuaSS_110470_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110470_0")) --我是一個快樂的伐木人～嘿嘿呦～嘿嘿呦～(唱)  太陽下山回家吃晚餐～咚咚咚～咚咚咚～(唱)
	Sleep(1800)
	end
end
...
function LuaSS_110497_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110497_0")) --想要保持健壯的好身材，就是要每天在陽光底下，工作工作工作。
	Sleep(59800)
	end
end
...
function LuaSS_110009_0()
	while 1 do	
	Say(OwnerID(),GetString("SC_110009_0")) --來追我呀～來追我呀～來追我呀～
	Sleep(1800)
	end
end
...
function LuaSS_110269_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110269_0")) --汪！汪！
	Sleep(1800)
	end
end
...
function LuaSS_110011_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110011_0")) --新鮮的肉，鮮嫩多汁美味可口的肉，快來買唷～
	Sleep(2400)
	end
end
...
function LuaSS_110012_0()
	while 1 do
	Say(OwnerID(),GetString("SC_110012_0")) --剛出爐，熱騰騰香噴噴的麵包，各種口味都有喔～
	Sleep(2590)
	end
end
...
function LuaIS_111352_0()
	while 1 do
	Say(OwnerID(),GetString("SC_111352_5")) --我是一個快樂的吟唱詩人～嘿嘿呦～嘿嘿呦～(唱)太陽下山回家吃晚餐～咚咚咚～咚咚咚～(唱)
	Sleep(1800)
	end
end
