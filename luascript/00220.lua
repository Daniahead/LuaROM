...
--	SetPlot( OwnerID(),"Touch","LuaFunc_Obj_BUSY",40)
	DisableQuest( OwnerID() , true )
	local Ankaria = CreateObjByFlag ( 110205 , 580022 , 1 , 1 )
...
--	SetPlot( Ankaria ,"Touch","LuaFunc_Obj_BUSY",40)
	...
	Sleep(10)
	PlayMotion( Ankaria,ruFUSION_ACTORSTATE_EAT)
