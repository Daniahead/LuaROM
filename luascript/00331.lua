...
function LuaQ_420329_Play() --打王的戰鬥劇情
	...
	local SNPC = {}
	local Monster = {}
	local Pailody = CreateObjByFlag( 110349 , 580038 , 3 , 1 )
	...
	while 1 do
		...
		if timer == 0 or timer == 10 or timer == 20 or timer == 30 then
			...
			for i = 4 , 6 , 1 do
				Race = Rand( 5 )
				if Race > 2 then
					Monster[j] = CreateObjByFlag( 100039 , 580038 , i , 1 ) --代用
				else
					Monster[j] = CreateObjByFlag( 100041 , 580038 , i , 1 ) --代用
				end
	...
	sleep( 30 )
	local ChronosOmu = CreateObjByFlag( 100135 , 580038 , 5 , 1 )
...
function LuaQ_420330_Accept()
	local HolpEgg = CreateObjByFlag( 110351 , 580038 , 3 , 1 )
