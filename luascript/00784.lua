function LuaS_421429_0()
	...
	local Monster = {}
	local ClassHighNo = LuaS_Discowood_FlagShowMonster( 100889 , "NoTarget" , 580089 , 3 , "LuaS_421429_1" )
	local Chailek = LuaS_Discowood_FlagShowMonster( 100888 , ClassHighNo , 580094 , 2 , "LuaS_421429_3" )
	Monster = {
			[1] = LuaS_Discowood_FlagShowMonster( 100887 , ClassHighNo , 580089 , 2 , "LuaS_421429_5" ),
			[2] = LuaS_Discowood_FlagShowMonster( 100887 , ClassHighNo , 580090 , 2  , "LuaS_421429_5" ),
			[3] = LuaS_Discowood_FlagShowMonster( 100887 , ClassHighNo , 580091 , 2  , "LuaS_421429_5" ),
			[4] = LuaS_Discowood_FlagShowMonster( 100886 , ClassHighNo , 580092 , 2  , "LuaS_421429_5" ),
			[5] = LuaS_Discowood_FlagShowMonster( 100886 , ClassHighNo , 580093 , 2  , "LuaS_421429_5" )
			}
	...
	local FightDone = 0
	while true do
		Array = LuaFunc_PartyData( TargetID() )--要記得改回target
		FightDone = 0
		for i=1 , Array[0] do

			if 	Checkflag ( Array[i] , 541593 ) or 
				CheckFlag( Array[i] , 541594 ) then

				FightDone = FightDone + 1

			end
		end


		if	FightDone == Array[0] then
------------------------------戰鬥結束，將風野聚落的人變友善
			Hide(Chailek)
