...
--	 --擺放士兵的位置是後來他們回到的原位
	...
	sleep( 10 )
	Say( OGD ,  GetString("SAY_110247_1") ) --/*你們聞起來和那群入侵者不同……是巫醫說的那群人類吧！
	sleep( 20 )
	Say( OGD ,  GetString("SAY_110247_2") ) --/*巫醫要我們別干擾你們的使命，而我也希望你們別干擾我們的作戰。
	LuaFunc_MoveToFlag( OGD,580030 , 0 ,0 )
	sleep( 30 )
	Say( OGD ,  GetString("SAY_110247_3") ) --/*不過若你們對於作戰內容有興趣，我這裡倒是有一些有意思的工作。	
	while 1 do 
		if Soldier[i] == -1 then
			break
		end
	...
	sleep( 30 )
	LuaFunc_MoveToFlag( OGD, 580030 , 2 ,0 )
	--這裡接開啟大門的劇情
...
function LuaI_420278_RUNNING()
	...
	LuaFunc_MoveToFlag( OwnerID() , 580030 , i+81 ,0 ) --擺放士兵的位置81~92
